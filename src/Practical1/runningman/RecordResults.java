...
/**
 * RecordResults.java A client program that uses the List ADT to keep track of
 * the list of runners and the list of marathon finishers.
 *
 * @author Kat Tan
 * @version 1.0
 */
public class RecordResults extends javax.swing.JFrame {
  ...
  private void jbtConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtConfirmActionPerformed
      //put runner into finisher
      runner = new Runner();
      runner.setName(jtfName.getText());
      runner.setNumber(Integer.parseInt(jtfNumber.getText()));
  ...
  private void jtfNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfNumberActionPerformed
      int inList = 0;
      int id = Integer.parseInt(jtfNumber.getText());
      
      //check the number entered in list ot not 
      for (int j = 0; j < runnerList.size(); j++) {
          if (id == runnerList.get(j).getNumber()) {
              jtfName.setText(runnerList.get(j).getName());
              inList = 1;
          }
      }
      
      //if number alrd in finisher, override the name displayed 
      for (int i = 0; i < finisherList.size(); i++) {
          if (id == finisherList.get(i).getNumber()) {
              jtfName.setText("--Runner already completed--");
          }
      }
      
      //if name not in finisher and not in runner
      if (inList == 0) {
          jtfName.setText("--Runner not registered--");
      }
     ...
     * For details see http://download.oracle.com/javase/tutorial/uiswing/lookandfeel/plaf.html 
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordResults.class
