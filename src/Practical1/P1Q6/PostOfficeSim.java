...
public class PostOfficeSim extends javax.swing.JFrame {
    ...
    private void jbtReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtReportActionPerformed
        ...
        //print report
        double totalWaitingTime = 0, averageWaitingTime;
        System.out.println(serviceList);
        for (int i = 0; i < serviceList.size(); i++) {
            str += " " + (i + 1) + "        " + serviceList.get(i).toString() + serviceList.get(i).getWaitingTime() + "\n";
            totalWaitingTime += serviceList.get(i).getWaitingTime();
        }

        str += "\nTotal Customer Served: " + serviceList.size();

        //calculate average waiting time and add into str
        averageWaitingTime = totalWaitingTime / serviceList.size();
    ...
    private void jbtCounter5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCounter5ActionPerformed
        ...
        //move the row 1 to row 2, row 2 to row 3 ...
        jtfRow4.setText(jtfRow3.getText());
        jtfRow3.setText(jtfRow2.getText());
        jtfRow2.setText(jtfRow1.getText());
        jtfRow1.setText(q.peek().getSeqNo() + " " + callString + "5");

        //when click the counter 5 record the counter and serve time
        q.peek().setCounter(5);
        q.peek().setServeTime(Calendar.getInstance());

        //poll into serveList and make other customer able to serve
    ...
    private void jbtTakeNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtTakeNumberActionPerformed
        //create new customer and put into queue.
        Customer cust = new Customer(nextNumber);
        jtaSlip.setText("Your Number is " + nextNumber);
        q.offer(cust);
        nextNumber++;
    ...
    private void jbtCounter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCounter1ActionPerformed
        ...
        jtfRow3.setText(jtfRow2.getText());
        jtfRow2.setText(jtfRow1.getText());
        jtfRow1.setText(q.peek().getSeqNo() + " " + callString + "1");

        //when click the counter 1 record the counter and serve time
        q.peek().setCounter(1);
        q.peek().setServeTime(Calendar.getInstance());
    ...
    private void jbtCounter2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCounter2ActionPerformed
        ...
        jtfRow3.setText(jtfRow2.getText());
        jtfRow2.setText(jtfRow1.getText());
        jtfRow1.setText(q.peek().getSeqNo() + " " + callString + "2");

        //when click the counter 2 record the counter and serve time
        q.peek().setCounter(2);
        q.peek().setServeTime(Calendar.getInstance());
    ...
    private void jbtCounter3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCounter3ActionPerformed
        ...
        jtfRow3.setText(jtfRow2.getText());
        jtfRow2.setText(jtfRow1.getText());
        jtfRow1.setText(q.peek().getSeqNo() + " " + callString + "3");

        //when click the counter 3 record the counter and serve time
        q.peek().setCounter(3);
        q.peek().setServeTime(Calendar.getInstance());
    ...
    private void jbtCounter4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCounter4ActionPerformed
        ...
        jtfRow3.setText(jtfRow2.getText());
        jtfRow2.setText(jtfRow1.getText());
        jtfRow1.setText(q.peek().getSeqNo() + " " + callString + "4");

        //when click the counter 4 record the counter and serve time
        q.peek().setCounter(4);
        q.peek().setServeTime(Calendar.getInstance());
